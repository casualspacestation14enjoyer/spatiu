	...
	//SECURITY//
	////////////
#define UPLOAD_LIMIT		7485760	//Restricts client uploads to the server to 7MB //Uebalo this thing. What's the worst that can happen?
...
/*/client/var/status_bar = 0

/client/proc/toggle_status_bar()
	status_bar = !status_bar
	if(status_bar && fullscreen)
		winset(src, "mainwindow", "is-maximized=false;can-resize=false;titlebar=false;menu=")
		winset(src, "mainwindow", "is-maximized=true;statusbar=true")
	if(status_bar && !fullscreen)
		winset(src, "mainwindow", "is-maximized=false;can-resize=true;titlebar=true;menu=menu;statusbar=true")
	if(!status_bar && fullscreen)
		winset(src, "mainwindow", "is-maximized=false;can-resize=false;titlebar=false;menu=")
		winset(src, "mainwindow", "is-maximized=true;statusbar=false")
	if(!status_bar && !fullscreen)
...
/*
/mob/verb/status_bar_toggle()
	set name = "Toggle Status Bar"
	set category = "OOC"
	client.toggle_status_bar()
*/
